...
# 
ELF := Controller_sw.elf

# Paths to C, C++, and assembly source files.
C_SRCS += driver/Counter.c
C_SRCS += driver/DisDriver.c
C_SRCS += driver/FRAM.c
C_SRCS += driver/KPLED.c
C_SRCS += driver/comInterface.c
C_SRCS += driver/coverPage.c
C_SRCS += driver/delay.c
C_SRCS += driver/loadWriteData.c
C_SRCS += driver/powerFailure.c
C_SRCS += driver/uart.c
C_SRCS += main/TopMenu.c
C_SRCS += main/main.c
C_SRCS += menuComponent/FireMenu.c
C_SRCS += menuComponent/HeaterWarmingUp.c
C_SRCS += menuComponent/ParameterMenu.c
C_SRCS += menuComponent/RemoteMenu.c
C_SRCS += menuComponent/SaveLoadMenu.c
C_SRCS += menuComponent/ShotCountersMenu.c
C_SRCS += menuComponent/ShutdownMenu.c
C_SRCS += menuComponent/StartupMenu.c
C_SRCS += menuComponent/editNum10.c
C_SRCS += menuComponent/editNum2.c
C_SRCS += menuComponent/editNum5.c
C_SRCS += menuComponent/enterPWD.c
C_SRCS += menuComponent/errorCheck.c
C_SRCS += menuComponent/pwdPage.c
C_SRCS += menuComponent/repPage.c
C_SRCS += menuComponent/shotPage.c
C_SRCS += menuComponent/timingPage.c
CXX_SRCS :=
ASM_SRCS :=
...
BSP_ROOT_DIR := ../Controller_sw_bsp/
